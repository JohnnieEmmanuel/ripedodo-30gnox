...
/* harmony import */ var _explore_container_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./explore-container.component.scss?ngResource */ 4673);
...
/***/ 437:
/*!***********************************************!*\
  !*** ./src/app/services/moviecrud.service.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "MoviecrudService": () => (/* binding */ MoviecrudService)
/* harmony export */ });
...
let MoviecrudService = class MoviecrudService {
    ...
    getMovies() {
        this.mov = this.httpClient.get(this.url + '/api');
        return this.mov
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(movies => console.log('Movies retrieved!')), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError('Get movie', [])));
    }
    getDetails(id) {
        return this.httpClient.get(this.url + '/api/fetch-movie/' + id)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(_ => console.log(`Movie fetched: ${id}`)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError(`Get movie id=${id}`)));
    }
    getComingsoon() {
        this.mov = this.httpClient.get(this.url + '/api/comingsoon');
        return this.mov
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(movies => console.log('Movies retrieved!')), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError('Get movie', [])));
    }
    movieupload(movie) {
        return this.httpClient.post(this.endpoint, JSON.stringify(movie), this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError('Error occured')));
    }
...
MoviecrudService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpClient }
];
MoviecrudService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 5881:
/*!*************************************************!*\
  !*** ./src/app/services/moviesearch.service.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MoviesearchService": () => (/* binding */ MoviesearchService),
...
let MoviesearchService = class MoviesearchService {
   ...
   */
    searchData(title, type) {
        return this.http.get(`${this.url}?s=${encodeURI(title)}&type=${type}&apikey=${this.apiKey}`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.map)(results => results['Search']));
    }
    /**
...
MoviesearchService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
MoviesearchService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/***/ 7171:
/*!*************************************************!*\
  !*** ./src/app/services/movieupload.service.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Movie": () => (/* binding */ Movie),
/* harmony export */   "MovieuploadService": () => (/* binding */ MovieuploadService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ 4929);
...
let MovieuploadService = class MovieuploadService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    ...
    movieupload(movie) {
        return this.httpClient.post(this.endpoint, movie, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError('Error occured')));
    }
    comingsoon(movie) {
        return this.httpClient.post(this.endpoint + '/comingsoon', movie, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError('Error occured')));
    }
...
MovieuploadService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpClient }
];
MovieuploadService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
/***/ 4621:
/*!************************************************!*\
  !*** ./src/app/services/watchlater.service.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Watchlater": () => (/* binding */ Watchlater),
/* harmony export */   "WatchlaterService": () => (/* binding */ WatchlaterService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ 8987);
...
let WatchlaterService = class WatchlaterService {
    ...
    getWl() {
        this.mov = this.httpClient.get(this.endpoint);
        return this.mov
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.tap)(movies => console.log('Movies retrieved!')), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError('Get movie', [])));
    }
    watchlater(watchlater) {
        return this.httpClient.post(this.endpoint + '/watchlater', watchlater, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError('Error occured')));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
...
WatchlaterService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpClient }
];
WatchlaterService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
        providedIn: 'root'
    })
], WatchlaterService);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_hp_RED_JOHN_DEV_ripedodo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_hp_RED_JOHN_DEV_ripedodo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_hp_RED_JOHN_DEV_ripedodo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
module.exports = "#container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n#container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\n#container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\n#container a {\n  text-decoration: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
